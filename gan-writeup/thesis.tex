...
\end{align*} \todo{Query player still doesn't work there (?)} \todo{}
...
\begin{definition}[Boolean Kernel]
    ...
    where $b$ determines the weight assigned to higher order polynomials. \todo{cite, also explain this much better}
\end{definition}
